...
void testCreateEl(){
  ...
  size_t size = 30;
  listElement* e = createEl(string,size,printChar);
  if(e == NULL)
...
void testInsertAfter(){
  ...
  size_t size = 30;
  listElement* e = createEl(string1,size,printChar);
  listElement* eNext = e->next;
  listElement* e2  = insertAfter(e,string2,size,printChar);
...
void testLength(){
  ...
  if(length(e) != 1)
    fail = true;
  insertAfter(e,string2,size,printChar);
  if(length(e) != 2)
    fail = true;
  deleteAfter(e);
  if(length(e) != 1)
...
void testPush(){
  ...
  listElement* e = createEl(string1,size,printChar);
  listElement** list = &e;
  push(list,string2,size,printChar);
...
void testEnqueue(){
  ...
  listElement* e = createEl(string1,size,printChar);
  listElement** list = &e;
  enqueue(list,string2,size,printChar);
